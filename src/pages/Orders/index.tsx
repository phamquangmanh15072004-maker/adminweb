    ...
    <div className="w-full xl:w-56 shrink-0 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-2">
      ...
      {status === 'PENDING' && (
        <button
          ...
          className="min-h-11 py-2.5 px-3 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-xl shadow-lg shadow-indigo-200 transition-colors disabled:opacity-50"
        >
